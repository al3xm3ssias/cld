            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Cadastrar novo laboratório</span>
                    </div>
                    <div class="card-body">
                        <div class="clearfix">
                        <form method="POST" action="{{ route('laboratorios.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <h6>Para cadastrar um novo solicitante basta preencher os campos como:<b>Número do Laboratório</b>, <b>Apelido</b> e se possui alguma <b>Restrição de acesso</b></h6>
