...
Cadastrar uma nova disciplinas
@endsection
            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Cadastrar uma nova disciplina</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('disciplinas.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
