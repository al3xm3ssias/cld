...
return [
    ...
    */
    ...
    'logo' => '<b>CLD</b>2021',
    'logo_img' => 'vendor/adminlte/dist/img/Atomo.png',
    ...
    */
    ...
    'right_sidebar_scrollbar_auto_hide' => 's',
            ...
            'files' => [
                ...
                [
                    ...
                    [
                        'type'=>'json',
                        'asset'=>true,
                        'location' => 'https://cdn.datatables.net/plug-ins/1.11.5/i18n/pt-BR.json',
                    ],
            ],
        ],
        'Select2' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/i18n/pt-BR.js',
                ],
            ],
        ],
        'Chartjs' => [
